        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="relative z-10">
              <h1 className="font-display text-2xl md:text-3xl tracking-[0.3em] font-light">
                BLAQROTH
              </h1>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-12">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  to={link.href}
                  className="link-underline text-sm tracking-widest uppercase font-body text-foreground/80 hover:text-foreground transition-colors"
                >
                  {link.name}
                </Link>
              ))}
